...
'step 4'
Mobile.tap(findTestObject('Dashboard/Taks/Overflow Menu/Delete/android.widget.TextView - Delete'), 2)
'step 5'
Mobile.tap(findTestObject('Dashboard/Taks/Overflow Menu/Delete/android.widget.Button - CANCEL'), 2)
'step 6'
