...
'step 4'
Mobile.tap(findTestObject('Dashboard/Layout/Navigate/Edite/android.widget.TextView - Edit'), 2)

'step 5'
Mobile.verifyElementVisible(findTestObject('Dashboard/Layout/Navigate/Edite/android.widget.TextView - Add Task'), 2)

'step 6'
Mobile.tap(findTestObject('Dashboard/Layout/Navigate/Edite/android.widget.EditText - Time'), 2)
...
'step 11'
Mobile.setText(findTestObject('Add Task/Time/Keyboard/android.widget.EditText - hour'), strHours, 2)
...
'step 16'
Mobile.tap(findTestObject('Dashboard/Layout/Navigate/Edite/android.widget.RelativeLayout'), 2)
